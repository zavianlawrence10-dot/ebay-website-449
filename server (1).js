...
// Set EBAY_APP_ID and EBAY_CERT_ID as environment variables in your deployment platform.
const EBAY_APP_ID = process.env.EBAY_APP_ID || "";
const EBAY_CERT_ID = process.env.EBAY_CERT_ID || "";

const EBAY_MARKETPLACE = process.env.EBAY_MARKETPLACE || "EBAY_GB"; // change to EBAY_US etc. if needed
